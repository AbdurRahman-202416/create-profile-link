...
const NullLink = () => {
  return (
    <div>
      <div className="self-stretch grow w-[100%] shrink basis-0 p-5 rounded-xl  h-full flex-col justify-center items-center gap-3 flex">
        <div className="self-stretch h-[284px] flex-col justify-start items-center gap-6 flex">
          ...
          <div className="self-stretch  text-[#727272] text-base font-normal text-justify lg: font-['Instrument Sans'] leading-normal">
