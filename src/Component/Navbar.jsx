...
const Navbar = () => {
  return (
    <div>
      <nav className="navbar m-5 navbar-expand-lg navbar-light bg-light">
        <div className="h-[42px] px-[27px] py-[11px] rounded-lg justify-center lg:gap-40  md:gap-40 sm:gap-5  items-center  flex">
          <div className="w-[74px] h-[42px]  rounded-lg relative hover:bg-indigo-100">
            <a href="#" className="pb-2 justify-center ">
              <svg
