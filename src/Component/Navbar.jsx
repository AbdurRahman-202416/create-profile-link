...
const Navbar = () => {
  return (
    <div>
      <nav className="navbar w-[100%] h-[100px] navbar-light bg-light">
        <div className="   rounded-lg gap-7 sm:gap-56  items-center  flex">
          <div className="w-[200px] h-[100px]  rounded-lg relative hover:bg-indigo-100">
            <Link to="#" className="pb-2 justify-center ">
              <svg
          ...
          <div className="w-[74px] h-[42px]  rounded-lg relative hover:bg-indigo-100">
            <Link to="/dashboard" className="pb-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                 width="21"
                height="20"
          ...
          <div className="w-[74px] h-[42px]  rounded-lg relative hover:bg-indigo-100">
            <Link to="/profile" className="pb-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="21"
                height="20"
          ...
          <div className="w-[74px] h-[42px]  rounded-lg relative hover:bg-indigo-100">
            <Link to="/preview" className="pb-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
